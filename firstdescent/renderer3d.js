...
if(renderer){
 ...
 const modelUniforms=m.userData.modelUniforms={motionTime:{value:0},rigKind:{value:0},hitFlash:{value:0},organicSurface:{value:organic?1:0},alienSurface:{value:0},pilotSurface:{value:0},terrainSurface:{value:0},terrainGrowth:{value:0},terrainBorder:{value:0},terrainNeutral:{value:0},sceneryLight:{value:0}};
 ...
 shader.fragmentShader=`varying vec3 vTerrainNormal; uniform float sceneryLight; uniform float terrainSurface; uniform float terrainGrowth; uniform float terrainBorder; uniform float terrainNeutral; varying float vTextureWeight; varying float vGlow; varying float vWet; varying vec3 vSkinPosition; uniform float alienSurface; uniform float pilotSurface; uniform float hitFlash; uniform float organicSurface;
