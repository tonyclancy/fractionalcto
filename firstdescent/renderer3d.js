...
if(!document.documentElement.hasAttribute('data-model-gallery'))await Promise.all(['audio.js','models.js','boss-creatures.js','boss-machines.js','capital-ship.js','levels.js','runs.js','art.js','wildlife-birds.js','wildlife-aquatic.js','wildlife-small-life.js','shore-wildlife.js','tide-encounter.js','game.js','cloud-config.js','collection-sync.js','collection-ui.js'].map(src=>new Promise((resolve,reject)=>{const s=document.createElement('script');s.async=false;s.src=src+new URL(import.meta.url).search;s.onload=resolve;s.onerror=reject;document.body.append(s)})));
