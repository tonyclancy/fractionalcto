...
function testLevelHotkey(e){
 ...
 if(travel){advanceSector();}else{level=target;resetSector();world=0;announce('TEST FLIGHT · '+expedition.locations[sectors[level].id].systemName,sectors[level].name);}
